...
const Hero: React.FC = () => {
  ...
  return (
    <div className="bg-black py-16 text-white w-full h-full bg-cover bg-center" style={{backgroundImage: `url('https://raw.githubusercontent.com/56b81caaa87941618cfed6dfb4d34047/Dinosaur_Battle_Simulator_1732568777/${window.MI_PROJECT_GIT_REF || 'main'}/src/assets/images/0baab26436c34b3981af497de051b17e.jpeg')`}}>
